...
# Set this to your Render URL e.g. https://ai-code-review-bot-xxxx.onrender.com
...
async def _keep_alive():
    """Background task that pings this server every 14 minutes."""
...
<div class="container">
  ...
  <div class="card">
    <h2>🔗 Add to any GitHub repo (takes 30 seconds)</h2>
    ...
    <div class="step"><div class="num">5</div><div class="txt">Click Save — open any PR and the bot reviews it automatically!</div></div>
  </div>
</div>
</body>
</html>"""
